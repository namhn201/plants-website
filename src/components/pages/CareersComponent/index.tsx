        ...
        .map((career: any) => {
          ...
          if (formData.position) {
            const filteredRoles = career.roles.filter((role: any) => {
              return role.title?.toLowerCase().includes(formData.position.toLowerCase());
            });
          ...
          //SEARCH COMPANY
          if (formData.company) {
            const companyMatch = career.company?.toLowerCase().includes(formData.company.toLowerCase());
          ...
          if (formData.location) {
            const locationMatch = career.location?.toLowerCase().includes(formData.location.toLowerCase());
