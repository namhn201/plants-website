      ...
      <div className="w-[93%] h-full">
        <div className="w-full h-full flex justify-center">
          <div className="w-full h-full lg:flex gap-5">
            ...
            <div className="lg:w-[25%]  rounded-3xl  p-3 flex flex-col bg-[#EDEDED]/60 mt-5 lg:mt-0">
              ...
              <div className="w-full h-[80%] p-5">
                <div className="w-full h-full">
                  ...
                  <div className="mt-5">
                    <p>
                      Cây Bằng Lăng là cây thân gỗ, tán dày, lá xanh hình oval,
                      dài 8-15 cm, rụng vào mùa thu. Hoa tím hoặc tím nhạt, mọc
                      thành chùm dài 20-30 cm, nở rộ vào mùa hè, mỗi bông 6 cánh
                      mỏng. Quả hình cầu, đường kính 1,5-2 cm, chuyển từ tím
                      nhạt sang nâu cứng khi chín. Ngoài hoa tím, còn có các
                      giống hoa màu hồng, tím sậm, tím trắng.
                    </p>
                  </div>
        ...
        <div className="w-full] bg-[#EDEDED] rounded-2xl mt-5 p-10 mb-5">
          <p className="text-2xl mb-">
            HƯỚNG DẪN CÁCH TRỒNG VÀ CHĂM SÓC CÂY BẰNG LĂNG
          </p>
          <p>
            Đặc thù của cây bằng lăng là sống ngoài trời, thích hợp với nơi có
            nhiều ánh sáng mặt trời. Nó sinh trưởng tốt trên đất tơi xốp, thoáng
            khí và dễ thoát nước. Trước khi trồng cây bằng lăng tầm 1 tháng, bạn
            nên bón phân cho đất trồng. Mục đích của việc này là cung cấp nguồn
            dinh dưỡng cần thiết cho cây bằng lăng (ngay khi nó được trồng).
          </p>
          <p>
            Thời điểm thích hợp nhất để trồng cây bằng lăng là khoảng tháng 5 –
            tháng 6 (nên trồng vào đầu mùa mưa). Có nhiều nước cây sẽ lớn nhanh
            và xanh tốt quanh năm. Để cây bằng lăng ra hoa đẹp, bạn nên chăm
            chút nhiều hơn đất trồng. Cụ thể như sau: mỗi năm nhặt cỏ xung quanh
            gốc cây 2-3 lần, kết hợp với đó là xới đất và vun gốc. Mỗi năm bón
            phân hữu cơ 1-2 lần. Cây bằng lăng không yêu cầu bạn tưới nước
            nhiều, cũng không cầu kỳ trong chăm sóc. Giống cây này đẹp nhất khi
            ra hoa. Hoa bằng lăng đạt hiệu quả cao trong làm đẹp. Không loài hoa
            nào đạt được tính lãng mạn và thanh tao của hoa bằng lăng.
          </p>
        </div>
      </div>
    </div>
