  ...
  return (
    <div className="h-[100dvh] min-w-[250px] overflow-x-hidden ${myFont.className}">
      ...
      <section className=" relative Layout flex flex-1 flex-col items-center gap-x-10 sm:p-0">
        ...
        {/* <div className="absolute bottom-0 [26%] left-0 rotate-[270deg]">
          <img className="w-
          [400px] h-full" src="/assets/plant_side_bg_5.jpg" alt="" />
        </div> */}
        ...
        {/* <div className="absolute top-[26%] left-0 hidden sm:block">
          <img className="w-[400px] h-full" src="/assets/plant_side_bg_6.jpg" alt="" />
        </div> */}
      </section>
      <Footer />
    </div>
